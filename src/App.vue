...
export default{
  data (){
    ...
    return {
      ...
      fechaExp: '01/23',
      propietario: 'Juan Perez Pereira',
      tarjetaChip: {
        chip: '/chip.png',
        visa: '/visa.png'
      }
...
<div id="app">
      <form>
        ...
        <div>
          ...
          <input v-model="tarjetaChip.chip">
        </div>
        ...
        <div>
          ...
          <input v-model="tarjetaChip.visa">
        </div>
      </form>

      <div class="carnet">
        <h3>{{ titulo }}</h3>
        <img width="40" :src="tarjetaChip.chip" alt="" />
        <div>
          <h2>{{ numero }}</h2>
        ...
        <footer>
          ...
          <img :src="tarjetaChip.visa" width="60" />
        </footer>
      </div>
    </div>
